...
def run(req: InstallRequirement,
    ...
    __np__.run_with_output("python.exe", os.path.join(source_dir, "makepanda", "makepanda.py"), "--everything", "--wheel", "--static", "--msvc-version=14.2", "--windows-sdk=10", "--no-tinydisplay" , "--threads=12", "--optimize=3")
